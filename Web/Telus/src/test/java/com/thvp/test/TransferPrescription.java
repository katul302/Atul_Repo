...
import com.thvp.pages.Consultation;
...
public class TransferPrescription extends TestBase {
	...
	public void transfer_test2(String Email, String Password, String Pharmacy, String Phone) throws Exception {
		...
		String Address_L1 = Utill.Address_L1;

		String Address_L2 = Utill.Address_L2;
		String city = Utill.city;
		String Postal = Utill.Postal;
		String Delivery_phone = Utill.Delivery_phone;
		String Ext = Utill.Ext;
		

//		log.info("Address 1" + Address_L1 + " and Address_L2" + Address_L2 + "and city" + city + "and Postal" + Postal
//				+ "and Delivery_phone" + Delivery_phone + "Ext" + Ext);
		ck.alt_add_radio().click();
		...
		con.ph().sendKeys(Delivery_phone);
		con.btn().click();
		con.place_btn().click();
